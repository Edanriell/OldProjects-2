...
const notifications: HTMLDivElement | null = document.querySelector(".notifications");
const messages: HTMLDivElement | null = document.querySelector(".messages");
...
notifications?.addEventListener("click", () => {
	...
	gsap.fromTo(
		".ringer",
		{ rotation: -3, x: 0.5 },
		{ rotation: 0, x: 0, duration: 1.2, ease: "elastic.out(5, 0.2)" }
	);
